...
from headphones import logger, searcher, db, importer, mb, lastfm, librarysync, gs
...
#                    "newzbin_pass" : headphones.NEWZBIN_PASSWORD,
    ...
    def configUpdate(self, http_host='0.0.0.0', http_username=None, http_port=8181, http_password=None, launch_browser=0, api_enabled=0, api_key=None,
        download_scan_interval=None, libraryscan_interval=None,
        download_dir=None,
        preferred_words=None, required_words=None, ignored_words=None,
        preferred_quality=0, preferred_bitrate=None, detect_bitrate=0, move_files=0,
        whatcd=0, whatcd_username=None, whatcd_password=None,
        rename_files=0, correct_metadata=0, cleanup_files=0, add_album_art=0, album_art_format=None, embed_album_art=0, embed_lyrics=0,
        ...
        remix=0, spokenword=0, audiobook=0, interface=None, log_dir=None, cache_dir=None, music_encoder=0, encoder=None, xldprofile=None,
