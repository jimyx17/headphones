...
def initialize():
    ...
    with INIT_LOCK:
        ...
        global __INITIALIZED__, FULL_PATH, PROG_DIR, VERBOSE, DAEMON, SYS_PLATFORM, DATA_DIR, CONFIG_FILE, CFG, CONFIG_VERSION, LOG_DIR, CACHE_DIR, \
                ...
                ADD_ALBUM_ART, ALBUM_ART_FORMAT, EMBED_ALBUM_ART, EMBED_LYRICS, DOWNLOAD_DIR, GROOVESHARK, BLACKHOLE, BLACKHOLE_DIR, USENET_RETENTION, SEARCH_INTERVAL, \
        ...
        GROOVESHARK = bool(check_setting_int(CFG, 'General', 'grooveshark', 0))
...
def config_write():
    ...
    new_config['General']['grooveshark'] = int(GROOVESHARK)
...
def dbcheck():
    ...
    c.execute('CREATE TABLE IF NOT EXISTS snatched (AlbumID TEXT, AlbumTitle TEXT, SongId TEXT, SongTitle TEXT, Size INTEGER, URL TEXT, DateAdded TEXT, Status TEXT, FolderName TEXT, Kind TEXT)')
